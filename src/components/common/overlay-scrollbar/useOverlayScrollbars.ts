...
type OverlayScrollbarsComponentProps<T extends ElementType = "div"> = OverlayScrollbarsComponentBaseProps<T> & {
...
): [UseOverlayScrollbarsInitialization, OverlayScrollbars | null] {
